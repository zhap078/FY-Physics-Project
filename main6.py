...
plt.plot(x,y, label="Measured Velocity 1")
plt.plot(x,z, label="Predicted Velocity 1")
plt.plot(x2,y2, label="Measured Velocity 2")
plt.plot(x2,z2, label="Predicted Velocity 2")
